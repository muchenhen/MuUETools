...
static FAutoConsoleVariableRef CVarNiaraGlobalSpawnCountScale(
	...
	TEXT("A global scale factor applied to spawn counts for emitters in Niagara. \n"),
	ECVF_Scalability
);
...
FNiagaraVariable INiagaraModule::Emitter_VisibilityTag;
#pragma endregion 
...
#pragma region Muchenhen (Niagara MeshRenderer Visibility Bug Fix)
	Emitter_VisibilityTag = FNiagaraVariable(FNiagaraTypeDefinition::GetIntDef(), TEXT("Emitter.VisibilityTag"));
#pragma endregion 
