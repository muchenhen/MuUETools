...
#pragma region Muchenhen (Niagara MeshRenderer Visibility Bug Fix)
	/*
...
#pragma region Muchenhen (Niagara MeshRenderer Visibility Bug Fix)
	if (bVisTagInParamStore && ParticleMeshRenderData.DynamicDataMesh->ParameterDataBound.IsValidIndex(RendererVisTagOffset))
	{
		int32 VisTag = 0;
		FMemory::Memcpy(&VisTag, ParticleMeshRenderData.DynamicDataMesh->ParameterDataBound.GetData() + RendererVisTagOffset, sizeof(int32));
