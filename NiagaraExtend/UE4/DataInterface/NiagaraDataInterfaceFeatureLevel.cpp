...
void UNiagaraDataInterfaceFeatureLevel::GetIfES31ForCPU(FVectorVMContext& Context)
{
...
void UNiagaraDataInterfaceFeatureLevel::GetIfSM5ForCPU(FVectorVMContext& Context)
{
	VectorVM::FUserPtrHandler<FFeatureLevelDataInterface_InstanceData> InstData(Context);
